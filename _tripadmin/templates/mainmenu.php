...
<?php 
	...
	if(getUserRight($_SESSION['auth']["id"], 'sitemap') && $_SESSION['auth']["id"]!=4) {
...
<?php            
	...
	if(getUserRight($_SESSION['auth']["id"], 'files') && $_SESSION['auth']["id"]!=4) {
...
<?php 
	...
	if(getUserRight($_SESSION['auth']["id"], 'modules') && $_SESSION['auth']["id"]!=4) {
...
<?php
		...
		if(getUserRight($_SESSION['auth']["id"], 'categories') && $_SESSION['auth']["id"]!=4) {
...
<?php
		...
		if(getUserRight($_SESSION['auth']["id"], 'lists') && $_SESSION['auth']["id"]!=4) {
...
<?php
		...
		if(getUserRight($_SESSION['auth']["id"], 'galleries') && $_SESSION['auth']["id"]!=4) {
...
<?php
		...
		if(getUserRight($_SESSION['auth']["id"], 'polls') && $_SESSION['auth']["id"]!=4) {
...
<?php
		...
		if(getUserRight($_SESSION['auth']["id"], 'catalogs') && $_SESSION['auth']["id"]!=4) {
...
<?php
		...
		if(getUserRight($_SESSION['auth']["id"], 'faqs') && $_SESSION['auth']["id"]!=4) {
...
<?php
		...
		if(getUserRight($_SESSION['auth']["id"], 'users') && $_SESSION['auth']["id"]!=4) {
...
<?php
        ...
        <li>
                ...
                <div class="rootmenu" >
                    ...
                    <a href="<?php echo ahref(array('cart'));?>">Orders</a>
